    ...
    public class OptionsMenuBehaviourStartPatch {
        ...
        public static void Postfix(OptionsMenuBehaviour __instance) {
            ...
            if ((ghostsSeeTasksButton == null || ghostsSeeTasksButton.gameObject == null)) {
                ghostsSeeTasksButton = createCustomToggle("幽灵查看剩余任务: ", TheOtherRolesPlugin.GhostsSeeTasks.Value, Vector3.right * xOffset, (UnityEngine.Events.UnityAction)ghostsSeeTaskToggle, __instance);
                ...
                void ghostsSeeTaskToggle() {
                    ...
                    updateToggle(ghostsSeeTasksButton, "幽灵查看剩余任务: ", TheOtherRolesPlugin.GhostsSeeTasks.Value);
                }
            }

            if ((ghostsSeeRolesButton == null || ghostsSeeRolesButton.gameObject == null)) {
                ghostsSeeRolesButton = createCustomToggle("幽灵查看玩家角色: ", TheOtherRolesPlugin.GhostsSeeRoles.Value, new Vector2(-xOffset, yOffset), (UnityEngine.Events.UnityAction)ghostsSeeRolesToggle, __instance);
                ...
                void ghostsSeeRolesToggle() {
                    ...
                    updateToggle(ghostsSeeRolesButton, "幽灵查看玩家角色: ", TheOtherRolesPlugin.GhostsSeeRoles.Value);
                }
            }

            if ((ghostsSeeVotesButton == null || ghostsSeeVotesButton.gameObject == null)) {
                ghostsSeeVotesButton = createCustomToggle("幽灵查看选票: ", TheOtherRolesPlugin.GhostsSeeVotes.Value, new Vector2(0, yOffset), (UnityEngine.Events.UnityAction)ghostsSeeVotesToggle, __instance);
                ...
                void ghostsSeeVotesToggle() {
                    ...
                    updateToggle(ghostsSeeVotesButton, "幽灵查看选票: ", TheOtherRolesPlugin.GhostsSeeVotes.Value);
                }
            }
            
            if ((showRoleSummaryButton == null || showRoleSummaryButton.gameObject == null)) {
                showRoleSummaryButton = createCustomToggle("角色摘要: ", TheOtherRolesPlugin.ShowRoleSummary.Value, new Vector2(xOffset, yOffset), (UnityEngine.Events.UnityAction)showRoleSummaryToggle, __instance);
                ...
                void showRoleSummaryToggle() {
                    ...
                    updateToggle(showRoleSummaryButton, "角色摘要: ", TheOtherRolesPlugin.ShowRoleSummary.Value);
                }
            }
        }
    }
